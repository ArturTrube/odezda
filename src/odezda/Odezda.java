    ...
    public static void main(String[] args) {
        ...
        switch(vibor){
            ...
            case 4:
                System.out.print("\n1. Тишка"
                        + "\n2. Штаны"
                        + "\nВыберите что вы хотите вывести:    ");
                int vivod = scan.nextInt();scan.nextLine();
                if (vivod == 1) {
                    
                    for (int i = 0; i < shmot.size(); i++) {
                    System.out.printf("В наличии есть: %d. %s цвета:%s, размер: %d, с ценой: %s\n", 
                    i+1,
                    shmot.get(i).getFirm(), 
            ...
            case 5:
                ...
                switch (choice) {
                    ...
                    int aa = 1;
                                        for (int i = 0; i < shmot1.size(); i++) {
                    System.out.printf("\n"+aa+".В наличии есть: %d. %s %s, размер: %s, с ценой: %s", 
                    aa++,
                    shmot1.get(i).getFirm2(), 
                    shmot1.get(i).getColor2(),
                    shmot1.get(i).getSize2(),
                    ...
                    if (pokupka == 1) {   
                        ...
                        for (int y = 0; y < username.size(); y++){
                            System.out.printf("\n"+a+".Есть аккаунт на номер телефона: %s",      
                                    username.get(y).getPhone());
                                    a++;
                        }
                            System.out.println("\nКакой аккаунт ваш? ");
                            int acc = scan.nextInt();scan.nextLine();
                            username.get(acc-1);
                            if(acc == a) {
                               double newbalance = username.get(acc-1).getBalance() - shmot1.get(aa).getPrice2();
